        ...
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="field">
                <div class="row">
                    ...
                    <div class="input-area"><input type="text" name="name" value="{{ old('name') }}" placeholder="" required></div>
                </div>
            </div>
            ...
            <div class="field">
                <div class="row">
                    ...
                    <div class="input-area"><input type="text" name="price" value="{{ old('price') }}" placeholder=""></div>
                </div>
            </div>
            ...
            <div class="field">
                <div class="row">
                    ...
                    <div class="input-area"><textarea name="description" placeholder="">{{ old('description') }}</textarea></div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="input-area">
                        <div style="display:flex;gap:8px">
                            <button type="button" class="btn-ghost" onclick="document.getElementById('imageFile').click()">tambahkan gambar</button>
                        ...
                        <div class="image-box" id="previewBox">
                            ...
                            <div id="previewPlaceholder" style="color:#666;display:flex;align-items:center;justify-content:center;">(preview gambar)</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function(){
            ...
            if(file) file.addEventListener('change', function(e){
                ...
                } else { if(img){ img.src=''; img.style.display='none'; } if(ph) ph.style.display='block'; }
            });
        });
    </script>

    <style>
        .product-create-wrap{ width:360px; max-width:96%; margin:10px auto; padding:8px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial }
        ...
        .label-box, .input-area{ min-height:42px; display:flex; align-items:center }
        .input-area textarea{ height:140px; align-items:flex-start; padding-top:12px; width:100%; box-sizing:border-box; overflow:auto; max-height:260px }
        ...
        .variants-row .btn-ghost{ flex:0 0 auto }
        .btn-ghost{ padding:8px 12px; border-radius:6px; background:#0084ff;color:#fff;border:0; height:36px }
        .chips{ margin-top:10px; display:flex; gap:8px; flex-wrap:wrap; align-items:center; min-height:40px }
